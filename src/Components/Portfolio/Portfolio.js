            ...
            <section className='Portfolio top' id='portfolio'>
                <div className='container'>
                    ...
                    <div className='hero_btn'>
                        ...
                        <a href="/Sulekha_Singh/#portfolio" active={filter === ''} onClick={() => setFilter('')}>
                        ...
                        <a href="/Sulekha_Singh/#portfolio" active={filter === 'FIGMA'} onClick={() => setFilter('FIGMA')}>
                        <button className='btn_shadow'>
                            <h2> FIGMA </h2>
                            {/*<i className="fab fa-github"></i>*/}
                        </button>
                        ...
                        <a href="/Sulekha_Singh/#portfolio" active={filter === 'APPLICATION'}
                        ...
                        <a href="/Sulekha_Singh/#portfolio" active={filter === 'PHOTOSHOP'} onClick={() => setFilter('PHOTOSHOP')}>
                            <button className='btn_shadow'>
                                <h2> PHOTOSHOP </h2>
                                {/*<i className="fab fa-github"></i>*/}
                            </button>
                        ...
                        <a href="/Sulekha_Singh/#portfolio" active={filter === 'WEB DESIGN'} onClick={() => setFilter('WEB DESIGN')}>
                            <button className='btn_shadow'>
                                <h2> WEB DESIGN </h2>
                                {/*<i className="fab fa-github"></i>*/}
                            </button>
